        ...
        <Grid container spacing={3}>
          <Grid item xs={8}>
            ...
            <Box className={classes.box} textAlign="left">
              ...
              <Typography component="span" variant="body2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</Typography>
            </Box>
          </Grid>
          ...
          <Grid item xs={4}> 
            <Card elevation={0} className={classes.box}>
              ...
              title="Vitor R Adriano"
              subheader="vradriano@hotmail.com"
              />
              <CardMedia 
              image="https://source.unplash.com/random"
              title="Vitor Ricardo Adriano"
              />
            </Card>
